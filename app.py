...
# Models are stored in artifacts/training/ relative to the project root
model_path = os.path.join(base_dir, "artifacts", "training", "model.joblib")
preprocessor_path = os.path.join(base_dir, "artifacts", "training", "preprocessor.joblib")
...
def load_artifacts():
    ...
    try:
        ...
        logging.info(f"Successfully loaded model and preprocessor from {base_dir}")        
